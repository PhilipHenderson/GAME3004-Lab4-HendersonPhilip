...
public class WorldGenerator : MonoBehaviour
{
    ...
    {
        tile.AddComponent<BoxCollider>(); ////////////////////////// Might find issues here
        tile.SetActive(false);
        pool.Enqueue(tile);
    ...
    {
        var normalArray = new Vector3[] { Vector3.up, Vector3.back, Vector3.right, Vector3.left, Vector3.forward, Vector3.back };
